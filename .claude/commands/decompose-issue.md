...
**Labels each sub-issue will receive:** complexity:low, testing:low; complexity:medium, testing:medium; complexity:medium, testing:medium
...
```bash
# ALWAYS apply both complexity: and testing: labels — required by triage policy
# Aim for complexity:low|medium per sub-issue
# Prefer testing:low (pure logic) or testing:medium (Discord bot setup) over testing:high (full GitHub Actions integration)
SUB_LABELS="complexity:${SUB_COMPLEXITY},testing:${SUB_TESTING}"
...
|-----------|-------|--------|
| #${SUB_1} | … | complexity:low, testing:low |
| #${SUB_2} | … | complexity:medium, testing:medium |
| #${SUB_3} | … | complexity:medium, testing:medium |
