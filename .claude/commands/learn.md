...
```
User: /learn better-sqlite3 prepared statements must use ? placeholders, not $1 or :name syntax
...
1. Discord thread names can exceed 100 characters without error, but the UI truncates at 100
   Evidence: VERIFIED -- created thread with 150-char name, API accepted it, UI showed truncated
