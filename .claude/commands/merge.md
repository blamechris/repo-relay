...
8. **Discord embed limits compliance** — title 256, desc 4096, fields 25 — verify in post-merge build
9. **SQLite concurrency** — better-sqlite3 parameterized statements only; no raw SQL
